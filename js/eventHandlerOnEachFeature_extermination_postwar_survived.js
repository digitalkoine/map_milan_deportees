...
function resetHighlight_extermination_postwar_survived (event) {
   ...
   jsonLayer_extermination_camps_postwar_survived.resetStyle(event.target);
};

function eventHandlerOnEachFeature_extermination_postwar_survived(feature, layer) {
    ...
    layer.on({
         ...
         'mouseout': resetHighlight_extermination_postwar_survived
     });
    ...
    layer.bindPopup(
      ...
      '<p>'+'<strong>'+feature.properties.quantity+'</strong>'+' persone dal nostro dataset sono sopravvissute alla chiusura del campo '+
      '<strong>'+feature.properties.convoyArrivalDate2+'</strong>'+'</p>'
    );
};

map.createPane('pane_jsonLayer_extermination_camps_postwar_survived');
map.getPane('pane_jsonLayer_extermination_camps_postwar_survived').style.zIndex = 406;
map.getPane('pane_jsonLayer_extermination_camps_postwar_survived').style['mix-blend-mode'] = 'normal';

var jsonLayer_extermination_camps_postwar_survived =  L.geoJSON(extermination_camps_postwar_survived, {
  pane: 'pane_jsonLayer_extermination_camps_postwar_survived',//set the style for the layer, using the function name present in layer_style.js
  style: style_extermination_camps_postwar_survived,
  ...
  onEachFeature: eventHandlerOnEachFeature_extermination_postwar_survived,
...
var jsonLayer_extermination_camps_postwar_survived_time =  L.TimeDimension.Layer.betweendates (jsonLayer_extermination_camps_postwar_survived, {
...
jsonLayer_extermination_camps_postwar_survived_time.addTo(map);
